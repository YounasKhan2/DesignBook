...
export default function GlobalSearchPage() {
  ...
  const results = useMemo(() => {
    ...
    return { designs: matchedDesigns, companies: matchedCompanies, dyes: matchedDyes };
  }, [q, designs, companies, dyes]);
      ...
      {!hasQuery && (
        <div className="text-center py-12">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            {["DSN-001", "Al Barsha", "Jet Black", "DYE-BK"].map((hint) => (
              <button
                key={hint}
        ...
        <div className="space-y-7">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-400 truncate">
                          {company?.companyName ?? "—"} · {d.dyeName} · {d.dyeNumber}
                        </p>
                      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-400">{c.companyNumber}{c.contactPerson ? ` · ${c.contactPerson}` : ""}</p>
                      </div>
                      <ArrowRight className="w-4 h-4 text-gray-300 shrink-0" />
                    </button>
                  );
          ...
          {results.dyes.length > 0 && (
            <section>
              ...
              <div className="space-y-2">
                {results.dyes.map((d) => {
                  const color = getDyeColor(d.dyeNumber);
                  return (
                    <button
                      key={d.id}
                    ...
                    >
                      <div
                        className="w-12 h-12 rounded-xl shrink-0 border border-black/5"
